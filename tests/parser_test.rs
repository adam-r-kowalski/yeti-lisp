...
#[test]
fn parse_integer() {
    let tokens = forge::Tokens::new("123");
    let actual = forge::parse(tokens);
...
fn parse_homogenous_array() {
    let tokens = forge::Tokens::new("[1 2 3]");
    let actual = forge::parse(tokens);
...
fn parse_heterogenous_array() {
    let tokens = forge::Tokens::new("[3.14 2 3]");
    let actual = forge::parse(tokens);
    let expected = forge::Expression::Array(vector![
...
#[test]
fn parse_map() {
    let tokens = forge::Tokens::new("{:a 1 :b 2}");
    let actual = forge::parse(tokens);
...
#[test]
fn parse_true() {
    let tokens = forge::Tokens::new("true");
    let actual = forge::parse(tokens);
...
#[test]
fn parse_false() {
    let tokens = forge::Tokens::new("false");
    let actual = forge::parse(tokens);
...
#[test]
fn parse_nil() {
    let tokens = forge::Tokens::new("nil");
    let actual = forge::parse(tokens);
